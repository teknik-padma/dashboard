...
# Lalu TITIK + HALONYA DIBUANG (malam yang sama, "maybe just remove the dot on the
# animation"): yang tersisa garis yang terukir sendiri, tanpa kepala cahaya.
...
<style>
  ...
  /* Titik laser + halonya DIBUANG (2026-09-25 malam, "maybe just remove the dot"). */
...
(function () {
  ...
  (function langkah() {
    ...
    JADWAL.forEach(function (J) {
      ...
      tepi(J, pt); arsir(J, jalur(dt, J.arsir));  // dua-duanya selalu dijalankan (goresan + tirai); titik laser dibuang
