...
Latar #16181C (= layar muat + background_color manifest), BUKAN #101010 milik
Padma Notes: splash Android disusul layar muat laser, dan dua gelap yang
berbeda terlihat sebagai kedipan di antara keduanya."""
import os, sys
